    ...
    <div className="min-h-screen bg-background font-sans text-foreground">
      ...
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-8 py-6">
        <Link to="/" className="flex items-center gap-2">
          ...
          <span className="text-xl font-semibold tracking-tight">Finova</span>
        </Link>
      ...
      <header className="mx-auto grid max-w-7xl items-center gap-16 px-8 pt-16 pb-24 lg:grid-cols-2">
        <div>
          <h1 className="font-semibold tracking-tight text-5xl leading-[1.1] md:text-6xl lg:text-7xl">
            Sua riqueza, <br />
          ...
          <div className="flex flex-wrap items-center gap-4">
            <Link
              to="/login"
              className="rounded-full bg-accent px-8 py-4 font-semibold text-accent-foreground transition-all hover:brightness-105"
            >
              Criar conta gratuita
            </Link>
            <a
              href="#funcionalidades"
              className="rounded-full border border-foreground/10 px-8 py-4 font-semibold transition-all hover:bg-card"
            >
              Ver demonstração
            </a>
          </div>
          ...
          <div className="rounded-3xl border border-primary/5 bg-card p-6 shadow-2xl shadow-primary/5 sm:p-8">
            ...
            <div className="mb-8 flex items-end justify-between">
              <div>
                ...
                <div className="mt-1 font-semibold tracking-tight text-3xl sm:text-4xl">R$ 42.850,00</div>
              </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between rounded-xl bg-secondary p-4">
                ...
                <div className="text-sm font-semibold text-negative">- R$ 2.400,00</div>
              </div>
              <div className="flex items-center justify-between rounded-xl bg-secondary p-4">
                <div className="flex items-center gap-3">
                  <div className="grid size-10 place-items-center rounded-full border border-foreground/5 bg-card">
                ...
                <div className="text-sm font-semibold text-positive">+ R$ 850,40</div>
              </div>
            </div>
      ...
      <section id="funcionalidades" className="bg-card py-24">
        <div className="mx-auto max-w-7xl px-8">
          <div className="grid gap-12 md:grid-cols-3">
            <div>
              <div className="mb-4 font-semibold tracking-tight text-3xl text-accent">01.</div>
            ...
            <div>
              <div className="mb-4 font-semibold tracking-tight text-3xl text-accent">02.</div>
            ...
            <div>
              <div className="mb-4 font-semibold tracking-tight text-3xl text-accent">03.</div>
        ...
        <div className="flex flex-col items-center gap-16 md:flex-row">
          <div className="w-full md:w-1/2">
            <img
              ...
              alt="Interface do app Finova mostrando dashboard financeiro em modo escuro com gráficos e categorias de despesa"
              width={1200}
              height={912}
              loading="lazy"
          ...
          <div className="w-full md:w-1/2">
            <h2 className="mb-6 font-semibold tracking-tight text-4xl md:text-5xl">Visualização clara do seu futuro.</h2>
      ...
      <footer className="mx-auto max-w-7xl border-t border-foreground/5 px-8 pt-16 pb-8">
        ...
        <div className="flex flex-col items-center justify-between gap-4 text-xs text-muted-foreground/60 md:flex-row">
          <span>© 2026 Finova Finance. Todos os direitos reservados.</span>
